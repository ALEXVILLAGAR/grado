...
@section('contenido')
<div class="row">
	<h1 class="col-md-10 text-center shadow-lg p-3 mb-5 bg-white rounded bg-info panel col-md-offset-1">Auxiliares</h1>
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1 datatable">
            ...
            <a class="btn btn-success col-md-5 col-md-offset-3" href="{{ route('auxiliar.create') }}" type="">
